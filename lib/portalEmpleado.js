        ...
        $('#divTotal').load("lib/ObtenerSecretarios.php", function() {
            ...
            $('#btnRecuperaInfo').click(function() {
                ...
                $.ajax({
                    ...
                    var string = '<table><tr><th>Secretaría</th><th>Fecha Recepcion</th><th style=\"display:none;\">Control Interno</th><th style=\"display:none;\">Numero de Oficio</th><th style=\"display:none;\">Oficio Referencia</th><th style=\"display:none;\">Medio de Entrega</th>' +
                        '<th style=\"display:none;\">Procedencia</th><th style=\"display:none;\">Nombre de escrito</th><th>Resumen Oficialia</th><th style=\"display:none;\">Asunto</th><th style=\"display:none;\">Control Seguridad</th><th style=\"display:none;\">Estatus</th><th style=\"display:none;\">Resumen General</th></tr>';
